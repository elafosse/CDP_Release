...
Il aurait également été préférable de voir l'analyse Sonar du git directement sur le GitHub (lien du Sonar : https://sonarcloud.io/dashboard?id=elafosse_CDP_Release). Cependant, nous n'avons pas trouvé comment faire. Nous n'avons pas non-plus réussi à faire en sorte que Sonar n'analyse pas les fichiers tests générés par Selenium.
